...
export const metadata = {
  title: 'VOVERA',
  description: 'Real-time voice attack detection pipeline — architecture, implementation, and benchmarks.',
};

export default function VoveraPage() {
  let project;
  try {
    project = getProjectContent('vovera');
  } catch {
    notFound();
  }
