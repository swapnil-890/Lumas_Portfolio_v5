...
export const metadata = {
  title: 'Steel Raven',
  description: 'Biomimetic drone architecture — design specifications, material selection, and engineering challenges.',
};

export default function SteelRavenPage() {
  let project;
  try {
    project = getProjectContent('steel-raven');
  } catch {
    notFound();
  }
